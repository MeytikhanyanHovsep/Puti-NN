            ...
            <div className="container  flex items-center justify-between max-md:flex-col max-md:gap-[30px] max-lg:gap-[50px] gap-[80px]">
                <div className="flex max-w-[560px] flex-col items-start gap-[20px] ">
                    <h3 className="text-[45px] max-md:text-[33px] lg:min-w-[380px] font-bold leading-tight">
                        ...
                        {!geoAllowed && (
                            <>
                                ...
                                <span className="primary">Местонахождения</span>
                            </>
                        )}
                    </h3>
                    <p className="mb-[20px] max-md:mb-[10px] gray-color">
                        {isTargetCity &&
                            geoAllowed &&
                            "Никаких долгих маршрутов, всё находится буквально рядом. Приходите, и мы спокойно оформим всё, что вам требуется, без лишнего давления и суеты."}
                        {!isTargetCity &&
                            geoAllowed &&
                            "Вы можете пройти оформление, получить консультации и решить рабочие вопросы удалённо. Всё сделано так, чтобы вы тратили минимум времени и всё получали там, где вам удобно."}
                        {!geoAllowed &&
